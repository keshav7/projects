package com.projects.lc.server.wrapper.service.enums;
...
public enum Errors implements com.projects.core.datatypes.enumInterfaces.Errors {
    ...
    LMS_LOAD_REQUEST_NOT_FOUND_FOR_TR_LINE_ITEM_EXT_ID("LOAD_REQUEST_NOT_FOUND_FOR_TR_LINE_ITEM_EXT_ID", 1421, HttpStatus.BAD_REQUEST, "Load com.projects.fc.server.core.request not found for tr line item ext id"),
