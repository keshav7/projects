...
public enum Errors implements com.projects.core.datatypes.enumInterfaces.Errors {
    ...
    LMS_CONTAINER_SERVICE_EXCEPTION("CONTAINER_SERVICE_EXCEPTION", 1408, HttpStatus.BAD_REQUEST, "Error in container service."),
    ...
    LMS_REQUEST_MANAGER_SERVICE_EXCEPTION("LOAD_MANAGER_SERVICE_EXCEPTION", 1425, HttpStatus.BAD_REQUEST, "Error in request manager service"),
    GROUP_ID_NOT_FOUND("GROUP_ID_NOT_FOUND_IN_REQUEST_MANAGER", 1426, HttpStatus.BAD_REQUEST, "Group ID not found in Request Manager service"),
    ...
    LMS_FAILED_TO_GET_SERVICE_REQUEST_DETAIL("LMS_FAILED_TO_GET_SERVICE_REQUEST", 1436 , HttpStatus.INTERNAL_SERVER_ERROR , "Failed to get service request detail"),
    ...
    LMS_LOCATION_SERVICE_ERROR("LMS_LOCATION_SERVICE_ERROR", 1439, HttpStatus.INTERNAL_SERVER_ERROR, "Location service error"),
    LMS_LOCATION_NOT_FOUND("LMS_LOCATION_NOT_FOUND", 1440, HttpStatus.BAD_REQUEST, "No location found"),
    REQUEST_MANAGER_SERVICE_ISSUE("REQUEST_MANAGER_SERVICE_ISSUE", 1441, HttpStatus.INTERNAL_SERVER_ERROR, "Request manager service Issue"),
    ...
    LMS_MISMATCH_IN_SR_TRACKING_ID_AND_ERP_CONSIGNMENT_TRACKING_IDS("LMS_MISMATCH_IN_SR_TRACKING_ID_AND_ERP_CONSIGNMENT_TRACKING_IDS",
            1447, HttpStatus.BAD_REQUEST, "There is mismatch in erp consignment shipment tracking ids and service request tracking ids"),
